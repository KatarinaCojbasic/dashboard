/**
 * Single entry point for analysis logs: uses PostgreSQL API when VITE_API_URL is set,
 * otherwise localStorage. Same interface as before (Supabase/localStorage).
 */
